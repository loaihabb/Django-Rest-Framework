...
class BlogPostListCreate(generics.ListCreateAPIView):
    ...
    def delete(self, request, *args, **kwargs): #* This For Delete All the objects in one time with one click
...
class BlogPostList(APIView):
    def get(self, request, format=None):
        ...
        if title: 
            ...
            blog_posts = BlogPost.objects.filter(title__icontaints=title)
        else:
